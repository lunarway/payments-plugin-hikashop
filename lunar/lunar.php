...
include_once('Lunar/Client.php');
include_once('Lunar/Currencies.php');
include_once('vendor/autoload.php');
include_once('helpers/Lunar_Keys_Validator.php');
...
class plgHikashoppaymentLunar extends hikashopPaymentPlugin
{
    ...
    public function getPaymentDefaultValues(&$element)
    {
        ...
        $element->payment_params->test_mode = 0; // disable test mode by default
    }
