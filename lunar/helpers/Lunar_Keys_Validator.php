...
if (! class_exists('LunarValidator')) :
  /**
  ...
  class LunarValidator
  {
      ...
      public function validateAppKeyField($value, $mode)
      {
          ...
          $lunarClient = new \Paylike\Paylike($value);
          try {
          ...
          try {
              ...
              $merchants = $lunarClient->merchants()->find($identity['id']);
              if ($merchants) {
