...
<tr <?php if(!isset($_GET['debug'])) echo 'hidden'; ?>>
	<td class="key">
		<label for="data[payment][payment_params][test_mode]"><?php echo JText::_('TEST_MODE');?></label>
	</td>
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][test_mode]" , '', $this->element->payment_params->test_mode);?>
	</td>
</tr>
